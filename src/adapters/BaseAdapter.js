class BaseAdapter {
    async saveSession(userId, jti, expiresAt) { throw new Error('Method not implemented'); }
    ...
    async getApiKey(key) { throw new Error('Method not implemented'); }
    ...
    async saveWebAuthnCredential(userId, credentialInfo) { throw new Error('Method not implemented'); }
